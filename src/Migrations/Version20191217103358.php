 ...
 */
final class Version20191217103358 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE activity CHANGE popular popular TINYINT(1) DEFAULT NULL');
...
');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE activity CHANGE popular popular TINYINT(1) DEFAULT \'0\'');
    }
}
